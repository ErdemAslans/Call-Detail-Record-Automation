...
export default defineComponent({
  ...
  setup() {
    const events = ref([
      ...
      {
        event:
          '<a href="#" class="text-gray-600 text-hover-primary me-1">Enes Danyıldız</a> has made payment to <a href="#" class="fw-bold text-gray-900 text-hover-primary">#XRS-45670</a>',
