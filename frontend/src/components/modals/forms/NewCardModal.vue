        ...
        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
          ...
          >
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              ...
              >
                <span class="required">{{ translate("nameOnCard") }}</span>
                <i
                  class="fas fa-exclamation-circle ms-2 fs-7"
                  data-bs-toggle="tooltip"
                  :title="translate('specifyCardHolder')"
                ></i>
              </label>
              <!--end::Label-->
            ...
            <div class="row mb-10">
              ...
              <div class="col-md-8 fv-row">
                <!--begin::Label-->
                <label class="required fs-6 fw-semibold form-label mb-2"
                  >{{ translate("expirationDate") }}</label
                >
                <!--end::Label-->
              ...
              <div class="col-md-4 fv-row">
                ...
                <label
                  class="d-flex align-items-center fs-6 fw-semibold form-label mb-2"
                >
                  <span class="required">{{ translate("cvv") }}</span>
                  <i
                    class="fas fa-exclamation-circle ms-2 fs-7"
                    data-bs-toggle="tooltip"
                    :title="translate('enterCardCVV')"
                  ></i>
                </label>
                <!--end::Label-->
            ...
            <div class="d-flex flex-stack">
              ...
              <div class="me-5">
                <label class="fs-6 fw-semibold form-label"
                  >{{ translate("saveCardForBilling") }}</label
                >
                <div class="fs-7 fw-semibold text-gray-500">
                  {{ translate("savingCardInfo") }}
                </div>
              </div>
              <!--end::Label-->
